...
<head>
    ...
    <!--Custom Favicon.-->
    <link rel="icon" type="image/png" sizes="64x64" href="logo_0.png">
    ...
    <!-- Navigation -->
        <nav class="navbar navbar-expand-lg navbar-dark static-top" style="background-color: #07698c; border-bottom:1px solid black;box-shadow: 3px 3px 5px;">
            <div class="container" style = "font-family:'PT Serif';font-size:22px;padding-right:0px;margin-right:0%;">
                <a class="navbar-brand" href="http://www.rvce.edu.in">
                    <h3 style = "font-family:'PT Serif';" ><img src="logo_0.png" width="70" style = "border-radius:50%;border:1px black;background-color:white;" height="70" alt="RVCE"/> <span class = "mh3">RVCE</span><br /><p style = "margin-left:6%;font-size:12px;margin-top:0;position:absolute;top:60px">Autonomous Institute, Affiliated to VTU<br />Estd. 1963</p></h3>
                </a>
        ...
        <div class="container">
  <!-- <div class="bg-image" 
            style="background-image: url(/images/ise.jpg);
            height: 70vh">
            </div> -->
	        ...
	        <div class="d-flex justify-content-center h-100">
		        ...
		        <div class="card mcon" id = "card">
                    ...
                    <button onclick="window.location.href = 'front.php';" class="btn btn-primary">Get student list for particular sem</button>
