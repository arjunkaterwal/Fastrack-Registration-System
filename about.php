	...
	<body>
		...
		<div class = "col-lg-7 mcon m-auto">
			...
			<p align="center" style = "font-weight:bold;text-shadow: 0.5px 0.5px black;font-size:20px;text-align:justify;">&nbsp;
				Fastrack Registration system is used in the effective dispatch of registration
			...
			<ol>
				<li>Online Fastrack Registration Portal helps the students in registering their fastrack and Semester End Examination Subjects Easily without manually registering but instead through online web Portal. </li>
