...
<body>
   ...
   <div class = "col-lg-6 m-auto mcon" style = "border-radius: none;">
      ...
      <h3 style = "text-shadow: 0.5px 0.5px black;padding-right: 10px;"> STUDENTS ELIGIBLE TO REGISTER FOR FASTRACK:</h3>
            <p align="left" style = "padding-left:5px;color:black;text-shadow: 0.5px 0.5px black;padding-right: 10px;font-size:20px;text-align:justify;">Who have failed in any semester <br/>
         <br/>
